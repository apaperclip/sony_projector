...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/apaperclip/sony_projector?quickstart=1)
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=sony_projector&category=integration)
...
1. Download the `custom_components/sony_projector/` folder from this repository
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=sony_projector)
...
Find all entities in **Settings** → **Devices & Services** → **Sony Projector** → click on the device.
...
```yaml
service: sony_projector.example_action
data:
  # Add your parameters here
```

### `sony_projector.reload_data`
...
```yaml
service: sony_projector.reload_data
```
...
4. Check the integration diagnostics (Settings → Devices & Services → Sony Projector → 3 dots → Download diagnostics)
