...
- Create new sensor file in `custom_components/sony_projector/sensor/`
- Inherit from `SonyProjectorEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Sony Projector."""
...
class SonyProjector[SensorName]Sensor(
    SonyProjectorEntity,
    SensorEntity,
):
...
- Entity: `custom_components/sony_projector/sensor/[sensor_name].py`
- Platform: `custom_components/sony_projector/sensor/__init__.py`
- Translations: `custom_components/sony_projector/translations/*.json`
