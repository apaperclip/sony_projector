...
**File:** `custom_components/sony_projector/services.yaml`
...
Create `custom_components/sony_projector/service_actions/[action_name].py`:

```python
"""[Action name] service action for Sony Projector."""
...
**File:** `custom_components/sony_projector/__init__.py`
...
**File:** `custom_components/sony_projector/const.py`
...
3. Find service action: `sony_projector.[action_name]`
...
- **Service actions directory:** `custom_components/sony_projector/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/sony_projector/services.yaml` (legacy filename)
- **Icons:** `custom_components/sony_projector/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/sony_projector/translations/*.json` under `services` key (legacy)
