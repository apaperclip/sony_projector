...
- Inherit from `SonyProjectorEntity` and platform base class
...
- Entity: `custom_components/sony_projector/[platform]/[entity_name].py`
- Platform: `custom_components/sony_projector/[platform]/__init__.py`
