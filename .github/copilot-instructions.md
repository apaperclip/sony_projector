...
- **Main code:** `custom_components/sony_projector/`
...
- `entity/` — Base entity class (`SonyProjectorEntity`)
...
- Entity MRO: `(PlatformEntity, SonyProjectorEntity)` — order matters
...
- Debug level: `custom_components.sony_projector: debug` in `config/configuration.yaml`
