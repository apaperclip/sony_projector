...
- **`entity/`** - Base entity classes (inherit `SonyProjectorEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, SonyProjectorEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import SonyProjectorEntity`
