...
- **Repository:** apaperclip/sony_projector

**Key directories:**

- `custom_components/sony_projector/` - Main integration code
...
- Integration logs: `custom_components.sony_projector: debug` in `config/configuration.yaml`
...
- **Domain:** `sony_projector`
- **Title:** Sony Projector
- **Class prefix:** `SonyProjector`

**When creating new files:**

- Use the domain `sony_projector` for all DOMAIN references
- Prefix all integration-specific classes with `SonyProjector`
- Use "Sony Projector" as the display title
...
- Inherit from platform base + `SonyProjectorEntity`
...
- `tests/` mirrors `custom_components/sony_projector/` structure
