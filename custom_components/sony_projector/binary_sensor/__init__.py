"""Binary sensor platform for sony_projector."""
...
from .connectivity import ENTITY_DESCRIPTIONS as CONNECTIVITY_DESCRIPTIONS, SonyProjectorConnectivitySensor
from .filter import ENTITY_DESCRIPTIONS as FILTER_DESCRIPTIONS, SonyProjectorFilterSensor
...
async def async_setup_entry(
    ...
    connectivity_entities = [
        SonyProjectorConnectivitySensor(
