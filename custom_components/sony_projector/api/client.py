...
class SonyProjectorApiClientCommunicationError(
    SonyProjectorApiClientError,
):
    """Exception to indicate a communication error with the API."""


class SonyProjectorApiClientAuthenticationError(
    SonyProjectorApiClientError,
):
...
def _verify_response_or_raise(response: aiohttp.ClientResponse) -> None:
    ...
    Raises:
        SonyProjectorApiClientAuthenticationError: For 401/403 errors.
        aiohttp.ClientResponseError: For other HTTP errors.

    """
    if response.status in (401, 403):
        msg = "Invalid credentials"
        raise SonyProjectorApiClientAuthenticationError(
            msg,
        )
...
class SonyProjectorApiClient:
    ...
    async def async_get_data(self) -> Any:
        ...
        Raises:
            SonyProjectorApiClientAuthenticationError: If authentication fails.
            SonyProjectorApiClientCommunicationError: If communication fails.
            SonyProjectorApiClientError: For other API errors.
    ...
    async def _api_wrapper(
        ...
        try:
            ...
            raise SonyProjectorApiClientCommunicationError(
                msg,
            ) from exception
            ...
            raise SonyProjectorApiClientError(
                msg,
            ) from exception
